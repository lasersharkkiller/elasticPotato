rule apt_malware_win_applejeus_oct22: LazyPine
{
    meta:
        ...
        severity = "critical"
        last_modified = "2025-05-21T15:04:45Z"
...
rule apt_malware_win_applejeus_b_oct22: LazyPine
{
    meta:
        author = "threatintel@volexity.com"
        date = "2022-11-03"
        ...
        scan_context = "file,memory"
        severity = "critical"
        last_modified = "2025-05-21T15:10:22Z"
        license = "See license at https://github.com/volexity/threat-intel/blob/main/LICENSE.txt"
        rule_id = 8497
        version = 5
...
rule apt_malware_win_applejeus_c_oct22: LazyPine
{
    meta:
        author = "threatintel@volexity.com"
        date = "2022-11-03"
        ...
        scan_context = "memory"
        severity = "critical"
        last_modified = "2023-09-28T09:56:57Z"
        license = "See license at https://github.com/volexity/threat-intel/blob/main/LICENSE.txt"
        rule_id = 8519
        version = 3
...
rule apt_malware_win_applejeus_d_oct22: LazyPine
{
    meta:
        author = "threatintel@volexity.com"
        date = "2022-11-10"
        ...
        scan_context = "file,memory"
        severity = "critical"
        last_modified = "2025-05-21T15:09:32Z"
        license = "See license at https://github.com/volexity/threat-intel/blob/main/LICENSE.txt"
        rule_id = 8534
        version = 3
