# Profile: Server (Windows Server 2022 - Member Server)
# CIS Microsoft Windows Server 2022 Benchmark v1.0 - Level 1 + Level 2

@{
    ProfileName = "Server"
    Description = "Full CIS L1+L2 hardened baseline for Windows Server 2022 member servers"
